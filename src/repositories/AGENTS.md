...
- Coordination snapshots and event invalidation verify live placement, containment, bare-repository shape, and exact refs/main, without scanning the full object graph. Latent object corruption is detected by the next full integrity boundary: content admission, mutation, startup, import/restore, or backup verification. Preserve those full checks and never substitute a retained healthy marker.

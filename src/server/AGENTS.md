...
- The server consumes package-owned wire v6 and Cloud binding v2 only from exact `@claudian-collab/protocol@3.3.1`. It never registers v1 and v2 in parallel, creates a compatibility shim/registry, or reinterprets v1 input as v2.

...
- The server consumes package-owned wire v5 and Cloud binding v2 only from exact `@claudian-collab/protocol@2.0.0`. It never registers v1 and v2 in parallel, creates a compatibility shim/registry, or reinterprets v1 input as v2.

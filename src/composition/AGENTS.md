...
- Startup validates deployment-profile constraints before accepting traffic. Shutdown stops new admission before closing dependencies used by admitted work.

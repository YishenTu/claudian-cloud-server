...
- Cloud return retains the exact handoff generation and trusts either its original Host binding or a cryptographically verified chain of committed physical Host activations. Pre-fence TLS transitions and copied receipt keys are not succession authority.
